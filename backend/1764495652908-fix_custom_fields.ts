...
export class FixCustomFields1764495652908 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE TABLE "product_variant" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "enabled" boolean NOT NULL DEFAULT true, "sku" character varying NOT NULL, "outOfStockThreshold" integer NOT NULL DEFAULT '0', "useGlobalOutOfStockThreshold" boolean NOT NULL DEFAULT true, "trackInventory" character varying NOT NULL DEFAULT 'INHERIT', "id" SERIAL NOT NULL, "featuredAssetId" integer, "taxCategoryId" integer, "productId" integer, "customFieldsRewardpoints" integer DEFAULT '0', CONSTRAINT "PK_1ab69c9935c61f7c70791ae0a9f" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "customer" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "title" character varying, "firstName" character varying NOT NULL, "lastName" character varying NOT NULL, "phoneNumber" character varying, "emailAddress" character varying NOT NULL, "id" SERIAL NOT NULL, "userId" integer, "customFieldsReferrerid" integer, "customFieldsTelegramid" character varying(255), "customFieldsPointbalance" integer DEFAULT '0', "customFieldsShoppingbalance" double precision DEFAULT '0', "customFieldsPaymentinfo" text, CONSTRAINT "REL_3f62b42ed23958b120c235f74d" UNIQUE ("userId"), CONSTRAINT "UQ_2fe0793eb3c56dac1c6962ed724" UNIQUE ("customFieldsTelegramid"), CONSTRAINT "PK_a7a13f4cacb744524e44dfdad32" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "top_up_request" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "amount" numeric(12,2) NOT NULL, "proofImage" character varying NOT NULL, "status" character varying NOT NULL DEFAULT 'Pending', "rejectionReason" character varying, "approvedAt" TIMESTAMP, "id" SERIAL NOT NULL, "customerId" integer, CONSTRAINT "PK_33c2d93fdc33054a3967f32fba3" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "withdrawal_request" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "pointsDeducted" integer NOT NULL, "cashAmount" numeric(12,2) NOT NULL, "paymentSnapshot" text NOT NULL, "status" character varying NOT NULL DEFAULT 'Pending', "transactionReference" character varying, "id" SERIAL NOT NULL, "customerId" integer, CONSTRAINT "PK_bc9a9e96931501edf31e665327f" PRIMARY KEY ("id"))`, undefined);
        await queryRunner.query(`CREATE TABLE "commission_log" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "amount" integer NOT NULL, "status" character varying NOT NULL DEFAULT 'Pending', "level" integer NOT NULL, "id" SERIAL NOT NULL, "beneficiaryId" integer, "sourceOrderId" integer, "sourceUserId" integer, CONSTRAINT "PK_d4d72e1c3d96a859f838edd4986" PRIMARY KEY ("id"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "customer" ADD CONSTRAINT "FK_81080ccdbcd33be8f6b7a01c4ff" FOREIGN KEY ("customFieldsReferrerid") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "top_up_request" ADD CONSTRAINT "FK_18ec50e6ef297b2d76868bdea8a" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "withdrawal_request" ADD CONSTRAINT "FK_1b201ef4b6132cbf5c64d9867d7" FOREIGN KEY ("customerId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "commission_log" ADD CONSTRAINT "FK_5342208e8859adb6dd25818b4b4" FOREIGN KEY ("beneficiaryId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "commission_log" ADD CONSTRAINT "FK_529214f2e9d3d519037bc68a7b9" FOREIGN KEY ("sourceOrderId") REFERENCES "order"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
        await queryRunner.query(`ALTER TABLE "commission_log" ADD CONSTRAINT "FK_e67dc010cc4dc42289bc4e34f73" FOREIGN KEY ("sourceUserId") REFERENCES "customer"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "commission_log" DROP CONSTRAINT "FK_e67dc010cc4dc42289bc4e34f73"`, undefined);
        await queryRunner.query(`ALTER TABLE "commission_log" DROP CONSTRAINT "FK_529214f2e9d3d519037bc68a7b9"`, undefined);
        await queryRunner.query(`ALTER TABLE "commission_log" DROP CONSTRAINT "FK_5342208e8859adb6dd25818b4b4"`, undefined);
        await queryRunner.query(`ALTER TABLE "withdrawal_request" DROP CONSTRAINT "FK_1b201ef4b6132cbf5c64d9867d7"`, undefined);
        await queryRunner.query(`ALTER TABLE "top_up_request" DROP CONSTRAINT "FK_18ec50e6ef297b2d76868bdea8a"`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "customer" DROP CONSTRAINT "FK_81080ccdbcd33be8f6b7a01c4ff"`, undefined);
        ...
        await queryRunner.query(`DROP TABLE "commission_log"`, undefined);
        await queryRunner.query(`DROP TABLE "withdrawal_request"`, undefined);
        await queryRunner.query(`DROP TABLE "top_up_request"`, undefined);
